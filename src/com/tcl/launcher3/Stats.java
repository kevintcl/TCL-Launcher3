...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.tcl.launcher3.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.tcl.launcher3.permission.RECEIVE_LAUNCH_BROADCASTS";
