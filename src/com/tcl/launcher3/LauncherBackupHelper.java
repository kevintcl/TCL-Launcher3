...
package com.tcl.launcher3;

import com.google.protobuf.nano.InvalidProtocolBufferNanoException;
import com.google.protobuf.nano.MessageNano;
import com.tcl.launcher3.LauncherSettings.Favorites;
import com.tcl.launcher3.LauncherSettings.WorkspaceScreens;
import com.tcl.launcher3.backup.BackupProtos;
import com.tcl.launcher3.backup.BackupProtos.CheckedMessage;
import com.tcl.launcher3.backup.BackupProtos.Favorite;
import com.tcl.launcher3.backup.BackupProtos.Journal;
import com.tcl.launcher3.backup.BackupProtos.Key;
import com.tcl.launcher3.backup.BackupProtos.Resource;
import com.tcl.launcher3.backup.BackupProtos.Screen;
import com.tcl.launcher3.backup.BackupProtos.Widget;
...
public class LauncherBackupHelper implements BackupHelper {
    ...
    public void performBackup(ParcelFileDescriptor oldState, BackupDataOutput data,
        ...
        out.key = keys.toArray(BackupProtos.Key.emptyArray());//EMPTY_ARRAY);
    ...
    public void writeNewStateDescription(ParcelFileDescriptor newState) {
        ...
        Journal out = new Journal();
        out.t = 0;
        out.key = mKeys.toArray(BackupProtos.Key.emptyArray());//EMPTY_ARRAY);
        writeJournal(newState, out);
